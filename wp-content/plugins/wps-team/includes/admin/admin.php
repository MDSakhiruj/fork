...
final class Admin
{
    ...
    public function register_admin_menu()
    {
        ...
        $shortcode_menu_title = __( 'Shortcodes', 'wpspeedo-team' );
        $settings_menu_title = __( 'Settings', 'wpspeedo-team' );
        $order_menu_title = __( 'Sort Order', 'wpspeedo-team' );
        $get_help_menu = __( 'Get Help', 'wpspeedo-team' );
        $tools_menu = __( 'Tools', 'wpspeedo-team' );
        add_submenu_page(
        ...
        if ( wps_team_fs()->is_not_paying() && !wps_team_fs()->is_trial() ) {
            add_submenu_page(
                Utils::get_top_label_menu(),
                __( 'WPS Team - Trial', 'wpspeedo-team' ),
                __( 'Free Trial', 'wpspeedo-team' ),
                'manage_options',
